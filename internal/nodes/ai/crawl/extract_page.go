...
// (provided directly or generated by a locally-installed AI agent).
type ExtractPageNode struct {
	Generator *cfgpkg.AgentGenerator
}
...
func (n *ExtractPageNode) Execute(ctx context.Context, input workflow.NodeInput, config map[string]interface{}) ([]workflow.NodeOutput, error) {
	...
	case "natural":
		if n.Generator == nil {
			return nil, fmt.Errorf("ai.extract_page: AI extraction requires a local agent generator (monomind)")
		}
