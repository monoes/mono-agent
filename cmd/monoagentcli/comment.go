...
func newCommentCmd(cfg *globalConfig) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  monoagentcli comment instagram https://www.instagram.com/p/ABC123/ --text "Great post!"
  monoagentcli comment instagram https://www.instagram.com/p/ABC123/ https://www.instagram.com/p/DEF456/ --text "Nice!"
  monoagentcli comment instagram --text "Love this!" https://www.instagram.com/p/ABC123/`,
